...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		...
		var back = new FlxSprite(-600, -300);
		back.frames = Paths.getSparrowAtlas('Cafe');
		back.antialiasing = ClientPrefs.globalAntialiasing;
		back.animation.addByPrefix('bump', 'cafe', 24);
		back.animation.play('bump');
		back.updateHitbox();
		add(back);
		...
		titleText = new FlxSprite(200, FlxG.height * 0.8);
	...
	override function beatHit()
	{
		...
		if(!closedState) {
			...
			{
				case 1:
					createCoolText(['Novisor Dev Team Inc.'], 45);
				...
				// credTextShit.screenCenter();
				case 5:
					createCoolText(['Novisor Series Made by'], -60);
				case 7:
					addMoreText('GameToons', -60);
				...
				// credTextShit.text = 'Shoutouts Shadow Mario';
				// credTextShit.screenCenter();
				case 9:
	...
	function skipIntro():Void
	{
		if (!skippedIntro)
		{
			...
			FlxTween.angle(logoBl, logoBl.angle, -10, 2, {ease: FlxEase.quartInOut});
